...
public class BEFORE_C01_Run {
	...
	public static String getHQL_airflow(String partition, Map<String, String> mapProp, String tableName ) {
		...
		String rs = "-----------------------------------------------------------------\n"
				+ "-- parameter list\n"
				+ "-----------------------------------------------------------------\n"
				+ "set hivevar:TARGET_TABLE="+tableName+";\n"
				+ "-----------------------------------------------------------------\n"
				+ "\n"
				+ "\n"
				+ "-- 清空驗証結果檔並重建\n"
				+ "drop table if exists "+mapProp.get("hadoop.tmp.dbname")+".${hivevar:TARGET_TABLE}_result;\n"
				+ "create table "+mapProp.get("hadoop.tmp.dbname")+".${hivevar:TARGET_TABLE}_result\n"
				+ "(\n"
				+ "   alias       string,\n"
				+ "   func_name   string,\n"
				+ "   msg         string,\n"
