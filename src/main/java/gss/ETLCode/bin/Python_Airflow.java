...
public class Python_Airflow {
	...
	public static String getDW(String tableName, String txtFileName, String sourceFileIsZip) {
		...
		String rs = "#!/usr/bin/env python3\n"
				...
				+ "DW_L07_LoadDW >> DW_L08_LoadDW_TMP >> check_rslt2 >> get_rslt_xcoms2 >> condition_rslt_to_go2 >> [check_fail, end_status]\n"
				+ "\n"
				+ "\n"
				+ "";
	...
	public static String getDM(String tableName, String txtFileName) {
		...
		String rs = "#!/usr/bin/env python3\n"
				...
				+ "BACKUP_DM >> TRUNCATE_DM >> DM_L02_LoadDM >> DM_L03_LoadDM_TMP >> check_rslt2 >> get_rslt_xcoms2 >> condition_rslt_to_go2 >> [check_fail, end_status]\n"
				+ "";
